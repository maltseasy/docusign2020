...
export default class WebMapView extends React.Component {
  ...
  componentDidMount() {
    loadModules(
      ["esri/map", "esri/InfoTemplate", "esri/layers/WFSLayer", "esri/config", "dojo/domReady!"],
      { css: true }
      ...
      var url = "https://dservices8.arcgis.com/32TQOipPYLOeSkYk/arcgis/services/Tree_loss_cluster/WFSServer";
      var opts = {
        "url": url,
        "version": "2.0.0",
