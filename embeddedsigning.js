...
const eg001EmbeddedSigning = exports,
  ...
  dsReturnUrl = dsConfig.appUrl + "/return",
  dsPingUrl = dsConfig.appUrl + "/ping"; // Url that will be pinged by the DocuSign Signing Ceremony via Ajax
/**
...
function makeEnvelope(args) {
  ...
  doc1.name = "Remote Audit Justification File"; // can be different from actual file name
...
eg001EmbeddedSigning.getController = (req, res) => {
  ...
  if (tokenOK) {
    res.render("pages/examples/eg001EmbeddedSigning", {
      ...
      title: "Embedded Signing Ceremony - FSC",
